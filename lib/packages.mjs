...
const packages = {
  '0http': { hasRouter: true, package: '0http', version: '3.5.1' },
  'uWebSockets': { version: '20.20.0' },
  'pure-http': { version: '3.3.1' },
  'express': { hasRouter: true, version: '4.18.2' },
  'fastify': { checked: true, hasRouter: true, version: '4.15.0' },
  'polka': { hasRouter: true, version: '0.5.2' },
  'polkadot': { hasRouter: false, version: '1.0.0' },
  'rayo': { hasRouter: true, version: '1.4.0' },
